...
Shader "ProPixelizer/SRP/PixelizedWithOutline2"
{
    ...
    Properties
    {
		...
		SubShader
		{
			...
			UsePass "ProPixelizer/Hidden/GPUInstanceGrassPixel/UNIVERSAL FORWARD"
			UsePass "ProPixelizer/Hidden/GPUInstanceGrassPixel/SHADOWCASTER"
			UsePass "ProPixelizer/Hidden/GPUInstanceGrassPixel/DEPTHONLY"
			UsePass "ProPixelizer/Hidden/GPUInstanceGrassPixel/DEPTHNORMALS"
	...
	FallBack "ProPixelizer/Hidden/GPUInstanceGrassPixel"
